...
for num=1:training_num
    ...
    temp_z = zeros(1,numOflevel2);
    for re=1:numOflevel2
        if(input_a1(re)>0)
            temp_z(re)=input_a1(re);
        end
    end
    input_z = [temp_z,1];
    input_a2 = input_z * w_level2 ; % w_level2 = [w1 w2 w3]
    %temp_z2 = sigmf(input_a2,[1 0]);
    temp_z2 = zeros(1,numOflevel3);
    for re=1:numOflevel3
        if(input_a2(re)>0)
            temp_z2(re)=input_a2(re);
        end
    end
    input_z2 = [temp_z2,1];
    ...
    derived_h2 = zeros(1,numOflevel3);
    for re = 1:numOflevel3
        if(input_a2(re)>0)
            derived_h2(re)=1;
        end
