...
int main(int argc,char** argv)
{
	...
	std::cout<<"pi is "<<4.0*piAns<<"  error: \e[40;38;5;201m"<<std::scientific<< (((4.0*piAns - 3.1415926)>0.0)?(4.0*piAns - 3.1415926):(-(4.0*piAns - 3.1415926)))
														   <<"\033[0m"<<std::endl;
	std::cout<<"pi is "<<4.0*piAns<<"  error: \e[39;39;5;201m"<<std::scientific<< (((4.0*piAns - 3.1415926)>0.0)?(4.0*piAns - 3.1415926):(-(4.0*piAns - 3.1415926)))
														   <<"\033[0m"<<std::endl;
	std::cout<<"pi is "<<4.0*piAns<<"  error: \e[41;40;5;201m"<<std::scientific<< (((4.0*piAns - 3.1415926)>0.0)?(4.0*piAns - 3.1415926):(-(4.0*piAns - 3.1415926)))
														   <<"\033[0m"<<std::endl;
	std::cout<<"pi is "<<4.0*piAns<<"  error: \e[42;48;5;201m"<<std::scientific<< (((4.0*piAns - 3.1415926)>0.0)?(4.0*piAns - 3.1415926):(-(4.0*piAns - 3.1415926)))
														   <<"\033[0m"<<std::endl;
